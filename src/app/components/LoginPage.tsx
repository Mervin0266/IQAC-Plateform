...
export function LoginPage({ onBack }: LoginPageProps) {
  ...
  const roles = [
    ...
    },
    {
      ...
      title: 'Faculty Login',
      description: 'Access to academic content and reports',
      icon: User,
    ...
    },
    {
      ...
      description: 'Department coordination and tracking',
      icon: Users,
          ...
          <div className="w-full max-w-md">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <Icon className="w-8 h-8 flex-shrink-0" style={{ color: role.iconColor }} />
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-white mb-1">{role.title}</h3>
                        <p className="text-sm" style={{ color: role.id === 'admin' ? 'rgba(255,255,255,0.6)' : 'rgba(255,255,255,0.65)' }}>
                          {role.description}
                        </p>
                      </div>
                    </div>
            ...
            <div className="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <div className="grid grid-cols-3 gap-3 text-xs text-gray-600">
                ...
                <div>
                  <p className="font-medium">Coord</p>
                  <p>coordinator / coordinator123</p>
                </div>
              </div>
            </div>
          </div>
