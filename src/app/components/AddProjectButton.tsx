...
export function AddProjectButton({ onClick }: AddProjectButtonProps) {
  ...
  return (
    <button 
      onClick={onClick}
      className="fixed bottom-6 left-80 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg transition-colors z-50 flex items-center space-x-2"
    >
